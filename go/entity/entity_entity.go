...
func NewEntityEntity(client *core.RoadieSDK, entopts map[string]any) *EntityEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EntityEntity) GetName() string { return e.name }
...
func (e *EntityEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EntityEntity) Deleted() bool {
	return e.deleted
}


func (e *EntityEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEntityEntity(e.client, opts)
}

func (e *EntityEntity) Data(args ...any) any {
...
func (e *EntityEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *EntityEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EntityEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *EntityEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// EntityCreateData and returns an Entity. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EntityEntity) CreateTyped(reqdata EntityCreateData, ctrl map[string]any) (Entity, error) {
...
func (e *EntityEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}



func (e *EntityEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// EntityRemoveMatch and returns an Entity. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *EntityEntity) RemoveTyped(reqmatch EntityRemoveMatch, ctrl map[string]any) (Entity, error) {
...
func (e *EntityEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
