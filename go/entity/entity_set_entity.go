...
func (e *EntitySetEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EntitySetEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
...
func (e *EntitySetEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
