...
const testSeed = `map[string]any{"entity": map[string]any{"entity": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "entity_set": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "entity_set_push": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
