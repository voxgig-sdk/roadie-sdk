...
func (sdk *RoadieSDK) OptionsMap() map[string]any {
...
func (sdk *RoadieSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RoadieSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RoadieSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RoadieSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RoadieSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RoadieSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RoadieSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RoadieSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RoadieSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RoadieSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *RoadieSDK) Entity(data map[string]any) RoadieEntity {
