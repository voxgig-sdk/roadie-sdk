...
class EntitySetPushEntity extends RoadieEntityBase<EntitySetPush> {
  ...
  async update(this: any, reqdata?: EntitySetPushUpdateData, ctrl?: Control): Promise<EntitySetPush> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<EntitySetPush> return stays clean under strict null checks.
