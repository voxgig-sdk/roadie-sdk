...
class EntityEntity extends RoadieEntityBase<Entity> {
  ...
  make(this: EntityEntity) {
    return new EntityEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: EntityLoadMatch, ctrl?: Control): Promise<EntityEntity> {
  ...
  async create(this: any, reqdata?: EntityCreateData, ctrl?: Control): Promise<EntityEntity> {
  ...
  async remove(
    this: any, reqmatch?: EntityRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<EntityEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
