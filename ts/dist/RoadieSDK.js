...
Object.defineProperty(exports, "RoadieEntityBase", { enumerable: true, get: function () { return RoadieEntityBase_1.RoadieEntityBase; } });
...
class RoadieSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('RoadieSDK: graphql: ' +
    ...
    // Entity access: `client.Entity().list()` / `client.Entity().load({ id })`.
    ...
    static test(testoptsarg, sdkoptsarg) {
        ...
        const testsdk = new RoadieSDK(sdkopts);
        testsdk._mode = 'test';
        return testsdk;
    }
    tester(testopts, sdkopts) {
        return RoadieSDK.test(testopts, sdkopts);
    }
    toJSON() {
        return { name: 'Roadie' };
    }
    toString() {
        return 'Roadie ' + this._utility.struct.jsonify(this.toJSON());
    }
    [node_util_1.inspect.custom]() {
        return this.toString();
    }
}
exports.RoadieSDK = RoadieSDK;
const SDK = RoadieSDK;
exports.SDK = SDK;
//# sourceMappingURL=RoadieSDK.js.map