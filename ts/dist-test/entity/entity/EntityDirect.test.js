...
(0, node_test_1.describe)('EntityDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-entity', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-entity', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-entity', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-entity', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.ROADIE_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ROADIE_TEST_ENTITY_ENTID'];
    ...
    const client = new __1.RoadieSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=EntityDirect.test.js.map