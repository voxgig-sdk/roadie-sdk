...
RoadieSDK._make_feature = _make_feature


function RoadieSDK.new(options)
  local self = setmetatable({}, RoadieSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function RoadieSDK:options_map()
...
function RoadieSDK:get_utility()
  return Utility.copy(self._utility)
end


function RoadieSDK:get_root_ctx()
  return self._rootctx
end


function RoadieSDK:prepare(fetchargs)
...
function RoadieSDK:direct(fetchargs)
...
-- by passing it.
function RoadieSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function RoadieSDK:graphql(query, variables, ctrl)
...
function RoadieSDK:Entity(data)
...
function RoadieSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = RoadieSDK.new(sdkopts)
  sdk.mode = "test"
