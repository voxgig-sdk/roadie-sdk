# Roadie JavaScript SDK



The JavaScript SDK for the Roadie API — an entity-oriented client with full async/await support.
...
```js
await client.Entity().remove({ id: 'entity_id' })
```
