...
|---|---|---|
| `js/` | @voxgig-sdk/roadie-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/roadie | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/roadie-js \
      --repository voxgig-sdk/roadie-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/roadie-js` shows it, and
`npm trust revoke @voxgig-sdk/roadie-js --id=<id>` removes it.
