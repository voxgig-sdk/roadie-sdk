...
// Roadie SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class RoadieMakeRequest
{
    public static function call(RoadieContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new RoadieResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new RoadieResponse($fetched);
        } else {
