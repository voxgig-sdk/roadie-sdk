...
class RoadieRbacFeature extends RoadieBaseFeature
{
    ...
    private function _required(RoadieContext $ctx): ?string
    {
    ...
    private function _reject(RoadieContext $ctx, string $required): void
    {
    ...
    private function _track(RoadieContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
