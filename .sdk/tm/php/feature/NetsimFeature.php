...
class RoadieNetsimFeature extends RoadieBaseFeature
{
    ...
    private function _simulate(RoadieContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(RoadieContext $ctx, array $applied): void
    {
        $client = $this->client;
