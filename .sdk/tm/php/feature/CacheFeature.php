...
class RoadieCacheFeature extends RoadieBaseFeature
{
    ...
    private function _through(RoadieContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
