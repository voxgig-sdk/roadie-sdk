...
class RoadieTimeoutFeature extends RoadieBaseFeature
{
    ...
    private function _with_timeout(RoadieContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(RoadieContext $_ctx, float $ms): void
    {
        $client = $this->client;
