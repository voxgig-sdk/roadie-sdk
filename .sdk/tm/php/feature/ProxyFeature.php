...
class RoadieProxyFeature extends RoadieBaseFeature
{
    ...
    public function init(RoadieContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (RoadieContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
