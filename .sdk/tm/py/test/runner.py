...
class RoadieTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RoadieTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = RoadieTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = RoadieTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
