...
class RoadieTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = RoadieTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = RoadieTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = RoadieTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
