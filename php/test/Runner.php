...
class RoadieTestRunner
{
    ...
    {
        $live = self::getenv('ROADIE_TEST_LIVE');
        $override = self::getenv('ROADIE_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ROADIE_TEST_EXPLAIN');
...
class_alias('RoadieTestRunner', 'Runner');
class_alias('RoadieHelpers', 'Helpers');
