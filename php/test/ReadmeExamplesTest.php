...
// Roadie SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (RoadieSDK::test)
...
{
    private const SDK_CLASS = 'RoadieSDK';
    ...
    private const SDK_BASE = 'roadie_sdk';
