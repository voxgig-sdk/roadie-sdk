...
class RoadieFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; RoadieSDK/1.0)';
    ...
    public static function call(RoadieContext $ctx, string $fullurl, array $fetchdef): array
    {
