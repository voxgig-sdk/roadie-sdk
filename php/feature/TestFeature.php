...
// Roadie SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class RoadieTestFeature extends RoadieBaseFeature
{
    ...
    public function init(RoadieContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (RoadieContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (RoadieContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(RoadieContext $ctx, $op, $args): array
    {
