...
class RoadieRatelimitFeature extends RoadieBaseFeature
{
    ...
    private function _acquire(RoadieContext $ctx): void
    {
    ...
    private function _track(RoadieContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
