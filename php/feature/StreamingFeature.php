...
class RoadieStreamingFeature extends RoadieBaseFeature
{
    ...
    private function _iterate(RoadieResult $result): \Generator
    {
    ...
    private function _streamable(RoadieContext $ctx): bool
    {
