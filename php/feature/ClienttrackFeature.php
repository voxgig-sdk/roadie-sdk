...
// Roadie SDK clienttrack feature
...
class RoadieClienttrackFeature extends RoadieBaseFeature
{
    ...
    public function PostConstruct(RoadieContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Roadie-SDK';
