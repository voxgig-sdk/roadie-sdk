...
class RoadiePagingFeature extends RoadieBaseFeature
{
    ...
    private function _graphql_pre_request(RoadieContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(RoadieContext $ctx): bool
    {
