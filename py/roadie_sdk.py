...
from core.utility_type import RoadieUtility
...
class RoadieSDK:
    ...
    def get_utility(self):
        return RoadieUtility.copy(self._utility)
    ...
    def EntitySet(self, data=None) -> "EntitySetEntity":
        ...
        from entity.entity_set_entity import EntitySetEntity
    ...
    def EntitySetPush(self, data=None) -> "EntitySetPushEntity":
        ...
        from entity.entity_set_push_entity import EntitySetPushEntity
        return EntitySetPushEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "RoadieSDK":
        if sdkopts is None:
            sdkopts = {}
