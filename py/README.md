...
The Python SDK for the Roadie API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Entity()` — each
...
The main module (`roadie_sdk`) exports the SDK class.
