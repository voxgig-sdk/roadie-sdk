...
from roadie_sdk.core.helpers import get_ctx_prop, to_map
...
class RoadieContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, RoadieResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return RoadieError(code, msg, self)
