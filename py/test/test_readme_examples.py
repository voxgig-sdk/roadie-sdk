# Roadie SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions RoadieSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both RoadieSDK(...) and RoadieSDK.test(...) become
#      RoadieSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "roadie_sdk"
_SDK_CLASS = "RoadieSDK"
