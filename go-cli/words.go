...
func registerSDKWords(r *eng.Registry, client *sdk.RoadieSDK) {
...
func runOp(client *sdk.RoadieSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
...
func entityFor(client *sdk.RoadieSDK, name string) (sdk.RoadieEntity, error) {
